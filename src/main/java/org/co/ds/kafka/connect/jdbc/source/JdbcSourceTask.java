...
package org.co.ds.kafka.connect.jdbc.source;
...
import org.co.ds.kafka.connect.jdbc.mbean.TableStats;
import org.co.ds.kafka.connect.jdbc.mbean.TableStatsModelMBean;
...
import org.co.ds.kafka.connect.jdbc.dialect.DatabaseDialect;
import org.co.ds.kafka.connect.jdbc.dialect.DatabaseDialects;
...
import org.co.ds.kafka.connect.jdbc.util.Version;
...
public class JdbcSourceTask extends SourceTask {
  ...
  /** The below declaration for MBEAN interface & running in batch mode*/
  private TableStats tableStats;
  private MBeanServer mBeanServer;
  private ObjectName mBeanObj;
  ...
  public void start(Map<String, String> properties) {
    ...
    dialect.setConnectionIsolationMode(
            ...
            JdbcSourceConnectorConfig.TransactionIsolationMode
                    .valueOf(
                            config.getString(
    ...
    //Register Mbean
    connectPort  = properties.get("connect.port");
  ...
  public void stop() throws ConnectException {
    ...
    // garbage collection tablestats
    tableStats = null;
    // deregister mbean server
    try {
  ...
  public List<SourceRecord> poll() throws InterruptedException {
    ...
    Thread.sleep(60000);//sleep for 1 min. to give chance to Mbean to register
    System.out.println("AFTER SLEEP");
    stopJdbcTask();
      // Stop and close all resources. Needed for running jdbc source connector in batch mode.
    return null;
  }
  ...
  private void registerModelMBean() {
    ...
    //instatntiate
    tableStats  = new TableStats(connectorName);
    ...
    try
    {
      mBeanObj = new ObjectName(
              "kafka.connect:type=jdbc_source_connector,connector="+  connectorName);
    ...
    //
    TableStatsModelMBean tableStatsModel =  new TableStatsModelMBean();
    ModelMBeanInfo dMBeanInfo = tableStatsModel.buildModelMBeanInfo( mBeanObj, connectorName );
    ...
    try {
      ...
      modelmbean.setManagedResource( tableStats, "ObjectReference");

      // register the model MBean in the MBean server
      mBeanServer.registerMBean( modelmbean, mBeanObj );


    } catch (Exception e) {
      log.error("\t!!! ModelAgent: Could not create the model MBean !!!");
      e.printStackTrace();
      //System.exit(1);
    }
  }

  private void unregisterModelMBean() throws InstanceNotFoundException, MBeanRegistrationException {
  ...
  private void stopJdbcTask()
  {
    HttpClient client = HttpClient.newHttpClient();

    String serviceUrl = "http://localhost:" + connectPort + "/connectors/" + connectorName;
